...
public class ScannerTest {
  public static void main(String[] args) {
    ...
    System.out.println("Enter an integer: ");   // Show prompting message
    num1 = in.nextInt();    // Use nextInt() to read an int
    System.out.println("Enter a floating point: ");   // Show prompting message
    num2 = in.nextDouble();
    System.out.println("Enter a string: ");   // Show prompting message
